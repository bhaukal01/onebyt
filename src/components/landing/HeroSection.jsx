  ...
  return (
    <section className="relative h-screen w-full overflow-hidden bg-black">
      ...
      <div className="relative z-10 h-full w-full">
        <div className="flex h-full flex-col justify-center gap-6 px-6 pt-24 pb-12 md:hidden">
          <div className="space-y-2">
            <h1 className="hero-title text-white font-medium text-[clamp(2.8rem,14vw,5.2rem)]">
              deploy
            </h1>
            <h1 className="hero-title text-white font-medium text-[clamp(2.8rem,14vw,5.2rem)]">
              any
          ...
          <p className="max-w-[24rem] text-[0.98rem] leading-snug text-white/90 m-0">
          ...
          <div className="flex flex-wrap gap-3">
            <a
              href="#plans"
              className="bg-white text-black text-[0.95rem] font-normal rounded-full px-6 py-3 hover:bg-neutral-200 transition-colors"
            >
              explore plans
            </a>
            <a
              href="#contact"
              className="bg-neutral-900/90 text-white text-[0.95rem] rounded-full px-6 py-3 border border-white/15 hover:text-white transition-colors"
            >
              book onboarding
            </a>
          </div>

          <div className="mt-2 grid grid-cols-2 sm:grid-cols-3 gap-4 text-xs text-white/70">
            <div>
              <p className="text-2xl font-medium tracking-tight text-white m-0">
                99.9%
              </p>
              <p className="m-0">uptime delivered</p>
            </div>
            <div>
              <p className="text-2xl font-medium tracking-tight text-white m-0">
                +10k
              </p>
              <p className="m-0">deployments managed</p>
            </div>
            <div>
              <p className="text-2xl font-medium tracking-tight text-white m-0">
                10+
              </p>
              <p className="m-0">provider networks</p>
            </div>
          </div>
        </div>
        ...
        <div className="relative hidden h-full w-full md:block">
          ...
          <div className="absolute left-6 md:left-10 top-[40%] max-w-sm flex flex-col items-start gap-6 z-20">
            <p className="max-w-[260px] text-[clamp(0.9rem,0.9vw,1.05rem)] leading-snug text-white/90 m-0">
              we manage deployments and hosting for web apps, apis, databases,
              and minecraft infrastructure with reliable cloud-first operations.
            </p>
